...
import type { AssistantMessage, Context, Model } from "pi-stable-ai";
...
vi.mock("pi-stable-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("pi-stable-ai/compat")>();
	return {
		...actual,
