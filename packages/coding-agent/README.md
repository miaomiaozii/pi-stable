...
```bash
npm install -g --ignore-scripts pi-stable
```
...
- [pi-stable-ai](https://www.npmjs.com/package/pi-stable-ai): Core LLM toolkit
- [pi-stable-agent-core](https://www.npmjs.com/package/pi-stable-agent-core): Agent framework
- [pi-stable-tui](https://www.npmjs.com/package/pi-stable-tui): Terminal UI components
