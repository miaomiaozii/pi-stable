...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "pi-stable";
...
```typescript
import { createAgentSession, SessionManager } from "pi-stable";
...
The `Agent` class (from `pi-stable-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "pi-stable-ai";
import { ModelRuntime } from "pi-stable";
...
```typescript
import { InMemoryCredentialStore } from "pi-stable-ai";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "pi-stable";
...
```typescript
import { createAgentSession } from "pi-stable";
...
import { createAgentSession, defineTool } from "pi-stable";
...
```typescript
import type { InlineExtension } from "pi-stable";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "pi-stable";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "pi-stable";
