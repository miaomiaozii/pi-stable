...
```bash
npm uninstall -g pi-stable
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g pi-stable`, `yarn global remove pi-stable`, or `bun uninstall -g pi-stable`.
