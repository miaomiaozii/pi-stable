...
export default defineConfig({
	...
	resolve: {
		alias: [
			{ find: /^pi-stable-telemetry$/, replacement: telemetryIndex },
			{ find: /^pi-stable-agent-core\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^pi-stable-agent-core\/node$/, replacement: agentNode },
			{ find: /^pi-stable-agent-core$/, replacement: agentIndex },
			{ find: /^pi-stable-ai$/, replacement: aiIndex },
		],
	},
});
